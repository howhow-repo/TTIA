...
EventContent = moniter2_data_pdu + struct.pack("<HBHB", 30, 1, 100, 0)

payload_pdu = struct.pack("<HHB1s", EventType, RouteID, RouteDirect, RouteBranch) + EventContent
...
class TestEventsUplink(TestBusMsgBaseCase):
    pdu_pack = pdu_pack
    MESSAGEID = MESSAGEID
